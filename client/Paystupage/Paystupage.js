    ...
    $('.submitEditPayBtn').click(function (e) {
        ...
        tableData.forEach((el) => {
            if (el['name'] === fullName && el['payClass'] === course) {
                Swal.fire({
                    title: "Bạn chắc chứ?",
                    text: "Bạn đang chỉnh sửa thông tin của " + el['name'] + " thuộc lớp " + el['payClass'],
                    icon: "warning",
                    showCancelButton: true,
                    confirmButtonColor: "#3085d6",
                    cancelButtonColor: "#d33",
...
function deletePay() {
    $('.deletePayBtn').click(function (e) {
        ...
        Swal.fire({
            title: "Bạn chắc chứ?",
            text: "Bạn đang xóa thông tin của " + tableData[id]['name'] + " thuộc lớp " + tableData[id]['payClass'],
            icon: "warning",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
            cancelButtonColor: "#d33",
    ...
    $('.submitEditPrizeBtn').click(function (e) {
        ...
        tableData.forEach((el) => {
            if (el['name'] === fullName && el['prizeClass'] === course) {
                Swal.fire({
                    title: "Bạn chắc chứ?",
                    text: "Bạn đang chỉnh sửa thông tin của " + el['name'] + " thuộc lớp " + el['prizeClass'],
                    icon: "warning",
                    showCancelButton: true,
                    confirmButtonColor: "#3085d6",
                    cancelButtonColor: "#d33",
...
function deletePrize() {
    $('.deletePrizeBtn').click(function (e) {
        ...
        Swal.fire({
            title: "Bạn chắc chứ?",
            text: "Bạn đang xóa thông tin của " + tableData[id]['name'] + " thuộc lớp " + tableData[id]['prizeClass'],
            icon: "warning",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
            cancelButtonColor: "#d33",
