...
class FileController {
    ...
    async addFile(req, res, next) {
        try {
            const { teacherName, className, fileName, filetype, fileAmount, fileStatus } = req.query;
            const queryResult = await File.addFile(teacherName, className, fileName, filetype, fileAmount, fileStatus);
            if (queryResult) {
